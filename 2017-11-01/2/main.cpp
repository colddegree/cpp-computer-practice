/*
 * Разработайте программную структуру мультисписка. В качестве данных, хранимых
 * по адресу элемента списка, является список. Реализуйте заполнение такого списка.
 * Наглядно структура данных показана на рисунке.
 * (https://pp.userapi.com/c837124/v837124282/65408/mdmu4YgC2HA.jpg)
 */
